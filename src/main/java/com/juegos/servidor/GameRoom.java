...
public class GameRoom {
    ...
    public void initializeGame() {
        switch (gameType) {
            case GameConstants.GAME_TICTACTOE:
    ...
    public void processMove(String playerId, String moveData) {
        ...
        try {
            switch (gameType) {
                case GameConstants.GAME_TICTACTOE:
                    TicTacToeGame ticTacToe = (TicTacToeGame) gameInstance;
                    validMove = ticTacToe.makeMove(playerId, moveData);
                    if (validMove) {
                        result = ticTacToe.checkGameEnd();
                    }
                    break;
